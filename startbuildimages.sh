...
docker build -t harryyhzhang/nodemanager ./nodemanager
docker build -t harryyhzhang/resourcemanager ./resourcemanager
docker build -t harryyhzhang/sparkr ./sparkr
